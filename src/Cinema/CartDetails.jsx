...
import check from "../assets/icons/checkout.svg";
        ...
        <div className="bg-white shadow-md dark:bg-[#12141D] rounded-2xl overflow-hidden p-5 md:p-9">
          ...
          <div className="space-y-8 lg:space-y-12 max-h-[450px] overflow-auto mb-10 lg:mb-14">
            {cartData.length > 0 ? (
              <>
                {cartData.map((movie) => (
                  <div key={movie.id} className="grid grid-cols-[1fr_auto] gap-4">
                    ...
                    <div onClick={() => handleRemove(movie)} className="flex justify-between gap-4 items-center">
              ...
              <p className="text-[#74766F] text-xl dark:text-gray-200 font-semibold text-center">No items in the cart</p>
            )}
          </div>
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <a onClick={onClose} className="border border-[#74766F] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] dark:text-gray-200 font-semibold text-sm" href="#">
              Cancel
            </a>
          </div>
        </div>
